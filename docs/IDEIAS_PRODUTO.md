...
- Mensagem de Primeiro acesso e passo a passo explicativo da plataforma 
- Uma central de Ajuda explicando cada funcionalidade disponivel da plataforma
- integração com api de tempo para mostrar se a pessoa quiser 
- integração com Spotify ( quando a pessoa começar um pomodoro pergunta se ela quer ouvir musica enquanto trabalha)
